...
# @Last Modified time: 2016-07-12 12:12:15
...
class AttributeFunctionWebsite(AttributeFunctionBase):
    ...
    def match(attr_vals):
        ...
        if not super(AttributeFunctionWebsite, AttributeFunctionWebsite).valid_counts(attr_vals, AttributeFunctionWebsite.valid_website, threshold=0.4):
            return False
